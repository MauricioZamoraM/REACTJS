...
export default function Standard() {
  ...
  if(DataForm){
    TipoSolicitudFormFields.id = getDataForm[0].tso_id;
    TipoSolicitudFormFields.nombre = getDataForm[0].tso_nombre;    
    TipoSolicitudFormFields.estado = getDataForm[0].tso_estado;     
  }
