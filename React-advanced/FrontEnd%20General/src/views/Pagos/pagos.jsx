...
import { usePagosStore } from '../../hooks/usePagosStore';
  ...
  return (
    <React.Fragment>
      ...
      <div className="main main-app p-3 p-lg-4">
        ...
        <Card.Body>
          <Grid
         data={pagos.listaPagos||[]}
            
              columns={[
                { id: 'id', name: 'Campo id', hidden: true },
                { id: 'identificacionCliente', name: 'Identificacion' },
              ...
              formatter: (cell, row) => {
                return h('Button', {
                  ...
                  onClick: () => getPagosUpdate(`${row.cells[0].data}`)
                }, 'Editar');
              }
            },
              // { 
