...
import crypto1 from "../../styles/assets/img/crypto1.jpg";
import crypto2 from "../../styles/assets/img/crypto2.jpg";
import crypto3 from "../../styles/assets/img/crypto3.jpg";
...
export default function Cryptocurrency() {
  ...
  var dataPie = {
    ...
    datasets: [{
      ...
      backgroundColor: ['#23A455', '#61CE70', '#33d685', '#0dcaf0', '#1c96e9', '#6e7985', '#ccd2da']
    }]
  };
            ...
            <Card className="card-one">
              <Card.Body className="overflow-hidden px-0">
                ...
                <ReactApexChart
                  ...
                  options={setOption('#23A455', 35, 85)}
                  type="area"
                  height={100}
                  className="apex-chart-ten"
                />
